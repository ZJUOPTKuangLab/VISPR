function [P,modelOut,err] = mine_MLE_fit(data,theta0,parameters,shared,normLamda,zernikenum)
...
% Considering the diameter of bead or not
...
data(data<=0) = 1e3*eps;
[newDudt,model] =  mine_vectorPSF(newTheta,parameters,map,shared,bead);
%need check negative
...
n = 1;
for i = 1:zernikenum+5 % need change, in this case we always asume 21 aberration plus x,y,z,n,bg
